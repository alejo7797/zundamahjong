...
export const patternDescs: {
  ...
  YAKUHAI_PAIR: {
    ...
    description:
      "The hand's pair is the player seat's wind, wind round's wind, or a dragon (or the North wind if playing with 3 players).",
  },
  CLOSED_PINFU: {
    displayName: "Pinfu",
    description:
      "All four melds are sequences, the wait pattern is an open wait, the pair is not a yakuhai tile, and the hand is closed.",
  },
  OPEN_PINFU: {
    displayName: "Open Pinfu",
    description:
      "All four melds are sequences, the wait pattern is an open wait, the pair is not a yakuhai tile, and the hand is open.",
  },
  NON_PINFU_TSUMO: {
    displayName: "Non Pinfu Tsumo",
    description:
      "The winning tile was drawn by the player, and the hand does not qualify for pinfu.",
  },
  ALL_TRIPLETS: {
  ...
  FOUR_CONCEALED_TRIPLETS: {
    ...
    description:
      "The hand contains four closed triplets or quads, and the winning tile is not part of the pair.",
  },
  FOUR_CONCEALED_TRIPLETS_1_SIDED_WAIT: {
    displayName: "Four Concealed Triplets 1-sided Wait",
    description:
      "The hand contains four closed triplets or quads, and the winning tile is part of the pair.",
  },
  THREE_QUADS: {
  ...
  NINE_GATES: {
    ...
    description:
      "The hand contains 1112345678999 in the same suit, plus one extra tile of that suit, and the winning tile is not the extra tile.",
  },
  TRUE_NINE_GATES: {
    displayName: "True Nine Gates",
    description:
      "The hand contains 1112345678999 in the same suit, plus one extra tile of that suit, and the winning tile is the extra tile.",
  },
  ALL_GREENS: {
  ...
  HALF_OUTSIDE_HAND: {
    ...
    description:
      "Every meld and pair uses a terminal or honour tile, and both terminals and honours are used.",
  },
  FULLY_OUTSIDE_HAND: {
  ...
  ALL_TERMINALS_AND_HONOURS: {
    ...
    description:
      "Every tile is a terminal or honour tile, and both terminals and honours are used.",
  },
  ALL_TERMINALS: {
  ...
  THIRTEEN_ORPHANS: {
    ...
    description:
      "The hand consists of every terminal and honour tile, plus one extra terminal or honour tile, and the winning tile is not the extra tile (this is a special hand structure).",
  },
  THIRTEEN_ORPHANS_13_SIDED_WAIT: {
    displayName: "Thirteen Orphans 13-sided Wait",
    description:
      "The hand consists of every terminal and honour tile, plus one extra terminal or honour tile, and the winning tile is the extra tile (this is a special hand structure).",
  },
  LITTLE_THREE_DRAGONS: {
    displayName: "Little Three Dragons",
    description:
      "The hand contains two triplets or quads of dragons, and a pair of the third dragon.",
  },
  BIG_THREE_DRAGONS: {
  ...
  FOUR_LITTLE_WINDS: {
    ...
    description:
      "The hand contains three triplets or quads of winds, and a pair of the fourth wind.",
  },
  FOUR_BIG_WINDS: {
  ...
  OPEN_WAIT: {
    ...
    description:
      "The winning tile is on one end of a sequence, and the other end of the sequence is not a terminal.",
  },
  CLOSED_WAIT: {
  ...
  EDGE_WAIT: {
    ...
    description:
      "The winning tile is on one end of a sequence, and the other end of the sequence is a terminal.",
  },
  DUAL_PON_WAIT: {
