...
def fill_missing_tiles(
    ...
    count_deck = Counter(four_player_deck + four_player_flowers)
...
test_deck1 = fill_missing_tiles(
    ...
    + [350, 351, 352, 353, 360, 361, 362, 363, 370, 371]
    + [82, 83],
)
...
test_deck_chankan = fill_missing_tiles(
...
test_deck_rinshan1 = fill_missing_tiles(
...
test_deck_rinshan2 = fill_missing_tiles(
    [410, 420, 430, 440, 310, 11, 12, 13, 20, 21, 22, 23, 30, 31, 32, 33]
    + [120, 121, 122, 123, 210, 220, 230, 240, 40, 41, 42, 43, 50, 51, 52, 53]
    + [130, 131, 132, 133, 250, 260, 270, 280, 60, 61, 62, 63, 70, 71, 72, 73]
    + [140, 290, 80, 81]
    + [141, 110],
    [311, 480, 10, 111, 112, 113, 450],
)
...
test_deck_riichi = fill_missing_tiles(
...
test_deck_furiten = fill_missing_tiles(
    [40, 41, 42, 50, 43, 80, 90, 310, 51, 61, 130, 131, 311, 312, 210, 211]
    + [60, 70, 71, 72, 212, 213, 220, 221, 132, 140, 141, 142, 222, 223, 230, 231]
    + [73, 110, 111, 112, 232, 233, 240, 241, 150, 151, 152, 192, 242, 243, 250, 251]
    + [190, 252, 193, 253]
    + [191, 260, 30, 261, 262, 263, 270],
    [20],
)
