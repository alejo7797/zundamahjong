...
class FormHandTest(unittest.TestCase):
    ...
    def test_two_winning_tile_melds(self) -> None:
        ...
        assert len(formed_hand_possibilities(tiles)) == 2
    ...
    def test_number_double_run(self) -> None:
        ...
        assert len(formed_hand_possibilities(tiles)) == 3
    ...
    def test_number_overlapping_run(self) -> None:
        ...
        assert len(formed_hand_possibilities(tiles)) == 1
