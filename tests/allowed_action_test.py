...
class TestAllowedAction:
    def test_play_default_actions(self) -> None:
        ...
        assert round.allowed_actions[1].default == SimpleAction(
            action_type=ActionType.PASS
        )
        assert round.allowed_actions[2].default == SimpleAction(
            action_type=ActionType.PASS
        )
        assert round.allowed_actions[3].default == SimpleAction(
            action_type=ActionType.PASS
        )

    def test_auto_actions(self) -> None:
        round = Round(tiles=test_deck1)
        assert round.allowed_actions[0].auto is None
        assert round.allowed_actions[1].auto == SimpleAction(
            action_type=ActionType.PASS
        )
        assert round.allowed_actions[2].auto == SimpleAction(
            action_type=ActionType.PASS
        )
        assert round.allowed_actions[3].auto == SimpleAction(
            action_type=ActionType.PASS
        )
    ...
    def test_discarded_default_actions(self) -> None:
        ...
        assert round.allowed_actions[0].default == SimpleAction(
            action_type=ActionType.PASS
        )
        assert round.allowed_actions[1].default == SimpleAction(
    ...
    def test_wrong_turn_nothing(self) -> None:
        ...
        assert round.allowed_actions[2].actions == [
            SimpleAction(action_type=ActionType.PASS)
        ]
        assert round.allowed_actions[3].actions == [
            SimpleAction(action_type=ActionType.PASS)
        ]
